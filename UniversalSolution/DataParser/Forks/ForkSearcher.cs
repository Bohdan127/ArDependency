...
{
    internal class ForkSearcher
    {
        private struct EventWithKof
        {
        ...
        public class Wylky
        {
            ...
            /// </summary>
            private Dictionary<int, EventWithKof> eventy;
            ...
            private double CheckEvent(EventWithKof arg)
            {
            ...
            /// <returns></returns>
            private double shearchMoney(double argM, double kofM, double kof)
            {
