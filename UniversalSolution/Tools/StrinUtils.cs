...
{       /// <summary>
    ...
    public static class StringUtils
    {
        ...
        /// <returns></returns>
        public static string GetFirstLineText(string text, bool isRichTextBox)
        {
            if (!isRichTextBox)
                return StringUtils.GetFirstLineText(text);
            else
            {
                ...
                if (!string.IsNullOrEmpty(text))
                {
                    ...
                    {
                        rtb.Rtf = text;
                        displayText = rtb.Text;
                    }
                    sRet = StringUtils.GetFirstLineText(displayText);
                }
                return sRet;
            }
        }
        ...
        /// <summary>
        /// Returns true if first param equals one of params list.
        ///
        /// <example>
        /// string s1 = "A";
        /// string s2 = "B";
        ...
        /// string s4 = "A";
        ///
        /// bool b1 = s1.Equals(s2) || s1.Equals(s3) || s1.Equals(s4);  //old fashion, b1 becomes true 'cause s1 equals s4
        ///
        /// bool b2 = StringIn(s1, s2, s3, s4); //b2 becomes true because s1 equals s4
        /// </example>
        /// </summary>
        /// <param name="string1">value that is examined if equals one of params list</param>
        /// <param name="strings">list of params that are tested against equality of string1</param>
        /// <returns>true if string1 equals one of passed string as params, false otherwise</returns>
        ...
        /// <summary>
        /// Get string length in twips
        /// </summary>
        /// <param name="graphics">The Graphics context to use</param>
        /// <param name="font">The Font of string </param>
        /// <param name="valueToCheck">string to check</param>
        /// <returns>value in twips</returns>
        public static int GetLengthInTwips(Graphics graphics, Font font, string valueToCheck)
        {
            float sizeInPixel = graphics.MeasureString(valueToCheck, font).Width;
            return Convert.ToInt32(sizeInPixel * 1440 / graphics.DpiX);
        }
